...
class GRUModel(BaseModel):
    """
        ...
        """
    def __init__(self, num_features, num_timesteps_input, num_timesteps_output, nhids=256, dropout=0.5, use_norm=False, device='cpu'):
        ...
        self.std_estimate = nn.Linear(nhids, num_timesteps_output)
    ...
    def forward(self, x, **kwargs):
        ...
        # Estimate data uncertainty (standard deviation)
        std_output = torch.exp(self.std_estimate(gru_out))  # Use exp to ensure positive values
        
        return {"mean": output, "std": std_output}
    ...
    def initialize(self):
        ...
        # Initialize the std_estimate layer
        init.xavier_uniform_(self.std_estimate.weight)
        self.std_estimate.bias.data.fill_(0)
