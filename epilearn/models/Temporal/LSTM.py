...
class LSTMModel(BaseModel):
    ...
    """
    def __init__(self, num_features, num_timesteps_input, num_timesteps_output, nhid=256, dropout=0.5, use_norm=False, **kwargs):
        super(LSTMModel, self).__init__(device=kwargs.get('device', 'cpu'))
